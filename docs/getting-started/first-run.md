...
- A **tool-bearing turn** (the usual Claude Code agentic loop) runs the whole council on the thinking channel, closes with a one-line **council recap**, then emits the synthesized tool call or answer.
